...
carol_candies = 109
to_smash = -1
newalice_candies=alice_candies-19
newbob_candies=bob_candies+25
newcarol_candies=carol_candies-7
print(newalice_candies)
print(newbob_candies)
print(newcarol_candies)
q4.check()
